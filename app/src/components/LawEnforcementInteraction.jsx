...
const QuickActions = ({ onQuickAction }) => {
  const quickActions = [
    { icon: AlertTriangle, text: "Emergency Rights", section: "rights" },
    { icon: Car, text: "Traffic Stop", section: "vehicle" },
    { icon: Users, text: "Street Stop", section: "street" },
    { icon: Home, text: "Home Visit", section: "home" }
  ];
        ...
        content: (
          <div className="space-y-6">
            <div className="bg-blue-900/20 rounded-xl p-6">
              <h2 className="text-2xl font-bold mb-4 text-text-primary text-text-primary">Are you the driver or a passenger?</h2>
